...
public class NewUserAccount extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		request.getRequestDispatcher("/WEB-INF/wiki/NewUserAccount.jsp")
	...
	protected void doPost(HttpServletRequest request,
		...
		if (usernameParam == "" || passwordParam == ""
				|| retypepasswordParam == "" || firstnameParam == ""
				|| lastnameParam == "" || emailParam == "") {
			...
			try {
				...
				PreparedStatement pstmt = c.getConnected()
